...
int main()
{
    ...
    For(i,1,T)
    {
        ...
        ll mx=0;
        /*representing result as binary no. to check all combinations
        if kth bit is 1 then kth person is honest otherwise unkind*/
