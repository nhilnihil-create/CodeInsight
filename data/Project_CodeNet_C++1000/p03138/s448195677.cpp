...
int main() {
  ...
  REP(i,N) REPR(j,40) if((A.at(i)>>j) & 1) b.at(j)++;
  ...
  REPR(i,40){
    ...
    if((K>>i & 1) == 1){
      if(dp.at(i+1).at(1)>=0){
        chmax(dp.at(i).at(1), dp.at(i+1).at(1)+ bit*(N-b.at(i)));
        chmax(dp.at(i).at(0), dp.at(i+1).at(1)+ bit*b.at(i));
      }
      if(dp.at(i+1).at(0)>=0){
        chmax(dp.at(i).at(0), dp.at(i+1).at(0)+ bit*max(b.at(i),(N-b.at(i))));
      }
    }
    
    if((K>>i & 1) == 0){
      if(dp.at(i+1).at(1)>=0){
        chmax(dp.at(i).at(1), dp.at(i+1).at(1)+ bit*b.at(i));
      }
      if(dp.at(i+1).at(0)>=0){
        chmax(dp.at(i).at(0), dp.at(i+1).at(0)+ bit*max(b.at(i),(N-b.at(i))));
      }
  ...
  COUT(max(dp.at(0).at(0), dp.at(0).at(1)));
