...
int main(int argc, char const *argv[])
{
    ...
    // Nは必ず偶数値
    // 各入力値は (2, 3, 4)、(1, 3, 4)、(1, 2, 4)、(1, 2, 3) のXOR になっている
    // つまり1番目のスカーフの値が欲しい時は、2, 3, 4番目の入力値を XOR すると、1 以外のものはちょうど偶数回 XOR されk消える。
    // よって、1 のスカーフの値が出てくる
    // そうすることで全体の共通値がわかる。スカーフ 1 XOR 入力値 1。あとはこの共通値とXORで答えが出る。
