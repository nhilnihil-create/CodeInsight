...
int main() {
    ...
    vector<vector<ll>> ifColors(3, vector<ll>(C + 1));

    ifColors[0][0] = ifColors[1][0] = ifColors[2][0] = 9999999999;
    ...
    for (ll c0 = 1; c0 <= C; c0++) {
        for (ll c1 = 1; c1 <= C; c1++) {
            ...
            for (ll c2 = 1; c2 <= C; c2++) {
                ...
                if (min > ifColors[0][c0] + ifColors[1][c1] + ifColors[2][c2]) {
                    min = ifColors[0][c0] + ifColors[1][c1] + ifColors[2][c2];
                }
            }
        }
    }
