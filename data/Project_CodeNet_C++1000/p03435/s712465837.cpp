...
int main() {
  vector<vector<int>> a(3, vector<int>(3));//int型の2次元配列(3×4要素の)の宣言
  for(int i=0;i<3;i++){
    for(int j=0;j<3;j++){
      cin >> a.at(i).at(j);
    }
  }
  if(abs(a.at(0).at(0) - a.at(0).at(1)) == abs(a.at(1).at(0) - a.at(1).at(1)) &&
     abs(a.at(0).at(0) - a.at(0).at(1)) == abs(a.at(2).at(0) - a.at(2).at(1)) &&
     abs(a.at(0).at(1) - a.at(0).at(2)) == abs(a.at(1).at(1) - a.at(1).at(2)) &&
     abs(a.at(0).at(1) - a.at(0).at(2)) == abs(a.at(2).at(1) - a.at(2).at(2)) )cout << "Yes"<<endl;
  else cout << "No"<<endl;
