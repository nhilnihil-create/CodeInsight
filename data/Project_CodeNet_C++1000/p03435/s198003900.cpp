...
int main(){
 ...
 ll cmp1=c[0][1]-c[0][0];
 if(c[1][1]-c[1][0]!=cmp1||c[2][1]-c[2][0]!=cmp1){
  pn;return 0;
 }
 cmp1=c[0][2]-c[0][0];
 if(c[1][2]-c[1][0]!=cmp1||c[2][2]-c[2][0]!=cmp1){
  pn;return 0;
 } 
 py;
return 0;}
/*
 ...
 0 1 0 1  0 0 c[1][0]
 0 0 1 1  0 0 c[2][0]
 0 0 0 -1 1 0 c[0][1]-c[0][0]*
 0 0 0 -1 1 0 c[1][1]-c[1][0]*
 0 0 0 -1 1 0 c[2][1]-c[2][0]*
 0 0 0 -1 0 1 c[0][2]-c[0][0]**
 0 0 0 -1 0 1 c[1][2]-c[1][0]**
 0 0 0 -1 0 1 c[2][2]-c[2][0]**
*/