...
int main() {
    ...
    string res = "Yes";
    rep(i, 3){
        if(c[i%3][0]-c[i%3][1]!=c[(i+1)%3][0]-c[(i+1)%3][1]) res = "No";
        if(c[i%3][2]-c[i%3][1]!=c[(i+1)%3][2]-c[(i+1)%3][1]) res = "No";
        if(c[0][i%3]-c[1][i%3]!=c[0][(i+1)%3]-c[1][(i+1)%3]) res = "No";
        if(c[2][i%3]-c[1][i%3]!=c[2][(i+1)%3]-c[1][(i+1)%3]) res = "No";
    }
    cout << res << endl;
}
