...
signed main() {
	...
	rep(1, i, n) {
		if (s[i] == 'A') {
			...
			dp2[i][1] = dp2[i - 1][0] + dp2[i - 1][1] + dp2[i - 1][2];
			dp2[i][1] += a * poow(3, q);
			int k = 0;
			if (q > 0)k = q * poow(3, q - 1);
			dp2[i][1] += k;
		}
		else if (s[i] == 'C') {
			dp2[i][2] = dp2[i - 1][0] + dp2[i - 1][1] + dp2[i - 1][2];
		}
		else {
			dp2[i][0] = dp2[i - 1][0] + dp2[i - 1][1] + dp2[i - 1][2];
			dp2[i][1] = dp2[i - 1][0] + dp2[i - 1][1] + dp2[i - 1][2];
	...
	rep(2, i, n) {
		if (s[i] == 'A') {
			...
			dp[i][2] = dp[i - 1][0] + dp[i - 1][1] + dp[i - 1][2] + dp2[i - 1][0] + dp2[i - 1][1] + dp2[i - 1][2];
		}
		else {
			dp[i][0] = dp[i - 1][0] + dp[i - 1][1] + dp[i - 1][2];
			dp[i][1] = dp[i - 1][0] + dp[i - 1][1] + dp[i - 1][2];
	...
	c((dp[n-1][0]+dp[n-1][1]+dp[n-1][2])%mod)
}