...
int floor(int A, int B, int x) {
    // x = (nB+r)とすると、
    // floor(A * x / B) - A * floor(x / B);
    // floor(A * (nB+r) / B) - A * floor((nB+r) / B);
    // floor(A * (nB+r) / B) - A * floor((nB+r) / B);
    // nA + floor(A * r / B) - (nA + A * floor(r/B));
    // floor(A * r / B) - A * floor(r/B)

    // A = mB + Rとすると、
    // floor(A * r / B) - A * floor(r/B)
    // floor((mB+R) * r / B) - A * floor(r/B)
    // mr + floor(R * r / B) - A * floor(r/B)
