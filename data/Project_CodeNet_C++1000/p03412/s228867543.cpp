...
int main(void)
{
  ...
  REP(i, 29)
  {
    ...
    REP(j, n)
    {
      ...
      {
        OUT("less");
        auto itrl = lower_bound(begin(Am), end(Am), l - b);
        auto itrr = --upper_bound(begin(Am), end(Am), r - b);
        ll val = (itrr - itrl + 1);
        OUT2("val", val);
        cnt += val;
      }
      ...
      {
        OUT("greater");
        auto nitrl = lower_bound(begin(Am), end(Am), r - b + 1);
        auto nitrr = --upper_bound(begin(Am), end(Am), l - b - 1 + base);
        ll val = n - (nitrr - nitrl + 1);
        OUT2("val", val);
        cnt += val;
      }
    }
