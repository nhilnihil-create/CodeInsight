...
signed main(){
 string a;
  cin>>a;
  bool b=0;
  if(a=="AKIHABARA"||a=="KIHABARA"||a=="AKIHBARA"||a=="AKIHABRA"||a=="AKIHABAR")
    b=1;
  else if(a=="KIHBARA"||a=="KIHABRA"||a=="KIHABAR"||a=="AKIHBRA"||a=="AKIHBAR")
    b=1;
  else if(a=="AKIHBR"||a=="KIHABR"||a=="KIHBAR"||a=="KIHBRA"||a=="AKIHABR")
    b=1;
  else if(a=="KIHBR")
    b=1;
  YESNO(b);
