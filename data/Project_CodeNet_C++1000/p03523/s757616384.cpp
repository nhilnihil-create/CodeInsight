...
signed main(){start();
    Vs s={"AKIHABARA","AKIHABAR","AKIHABRA","AKIHABR","AKIHBARA","AKIHBAR","AKIHBRA","AKIHBR","KIHABARA","KIHABAR","KIHABRA","KIHABR","KIHBARA","KIHBAR","KIHBRA","KIHBR"};
    string t;
    cin>>t;
    REP(i,0,s.size()) if(t==s[i]){cout<<"YES"<<endl;return 0;}
    cout<<"NO"<<endl;
    return 0;
}
