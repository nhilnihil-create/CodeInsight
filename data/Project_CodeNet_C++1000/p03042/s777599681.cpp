...
auto solve(){
	...
	int t1 = (in[0] - '0') * 10 + (in[1] - '0');
	int t2 = (in[2] - '0') * 10 + (in[3] - '0');
 
	if (t1 >= 1 && t1 <= 12 && t2 >= 1 && t2 <= 12) return !printf("AMBIGUOUS\n");
	if (t1 >= 1 && t1 <= 12) return !printf("MMYY\n");
	if (t2 >= 1 && t2 <= 12) return !printf("YYMM\n");
	return !printf("NA\n");
}
signed main() {
	unsyncIO();
