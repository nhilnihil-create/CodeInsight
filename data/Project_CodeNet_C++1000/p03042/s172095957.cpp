...
signed main()
{
    ...
    reads(s)
    int x[4]; fori (i, 0, 3) x[i] = (int)(s[i] - '0');
    ...
    if(m == 0)
    {
    	if(y >= 1 && y <= 12) print("YYMM")
    	else print("NA")
    }

    else if(y == 0)
    {
    	if(m >= 1 && m <= 12) print("MMYY")
    	else print("NA")
    }

	else if(m > 12 && y > 12) print("NA")

	else if(m <= 12 && y <= 12) print("AMBIGUOUS")

	else if(m <= 12) print("MMYY")
	else print("YYMM")
