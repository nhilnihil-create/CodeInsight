...
signed main(){
  string S; cin>>S;
  int a=int(S.at(0)-48)*10+int(S.at(1)-48);
  int b=int(S.at(2)-48)*10+int(S.at(3)-48);
  if(a<13&&a>0&&b<13&&b>0)cout<<"AMBIGUOUS"<<endl;
  else if(a<13&&a>0)cout<<"MMYY"<<endl;
  else if(b<13&&b>0)cout<<"YYMM"<<endl;
  else cout<<"NA"<<endl;
}