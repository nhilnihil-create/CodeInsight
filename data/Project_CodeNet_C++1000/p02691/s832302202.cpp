...
void PrintVector(vector<ll> v,int n)
{
...
int main(int argc, char const *argv[])
{
   ...
   // PrintVector(v1,n);
    ...
    {
      int cur=v1[i];
      bool b=binary_search(v2.begin(),v2.end(),cur);
      if(b)
      {
            auto it=lower_bound(v2.begin(),v2.end(),cur);
            auto it2=upper_bound(v2.begin(),v2.end(),cur);
            ans+=it2-it;
      }
    }
