...
ll MOD = 1000000007; ll INF = 1LL << 62; ll ans = 1; ll z = 0, o = 1;
...
int main() {
	...
	ll Q1 = T1 * B1;
	ll Q2 = Q1+T2 * B2;
	if ((P1 > Q1 && P2 > Q2) || (P1 < Q1 && P2 < Q2)) cout << 0;
	else if (P2 == Q2) cout << "infinity";
	else {
		ans = (abs(P1 - Q1) / abs(Q2 - P2)) * 2 + 1;
		if (abs(P1 - Q1) % abs(Q2 - P2) == 0) ans--;
		cout << ans;
	}
}