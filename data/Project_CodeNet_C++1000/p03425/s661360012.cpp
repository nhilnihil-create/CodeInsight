...
int main()
{
   ...
   fam(m,it)
   {
     ...
     {
       c=a[0]*a[1]*a[2]+a[1]*a[2]*a[3]+a[2]*a[3]*a[0]+a[3]*a[2]*a[0]; 
       //cout<<c;
     }
     else
     {
        c= c=a[0]*a[1]*a[2]+a[1]*a[2]*a[3]+a[3]*a[2]*a[0]+a[3]*a[0]*a[1]+a[2]*a[3]*a[4]+a[3]*a[4]*a[0]+a[4]*a[0]*a[1]+a[1]*a[2]*a[4]+a[1]*a[3]*a[4]+a[4]*a[0]*a[2];
     }
     if(l<3)
     cout<<0;
     else
