...
int main() {
  ...
  rep(i,n) cin >> s.at(i);
  rep(i,n){
    if(s.at(i).at(0) =='M') mcount++;
    if(s.at(i).at(0) =='A') acount++;
    if(s.at(i).at(0) =='R') rcount++;
    if(s.at(i).at(0) =='C') ccount++;
    if(s.at(i).at(0) =='H') hcount++;
  }
  ll sum  = 0;
  sum += mcount * acount * rcount;
  sum += mcount * acount * ccount;
  sum += mcount * acount * hcount;
  sum += mcount * rcount * ccount;
  sum += mcount * rcount * hcount;
  sum += mcount * ccount * hcount;
  sum += acount * rcount * ccount;
  sum += acount * rcount * hcount;
  sum += acount * ccount * hcount;
  sum += rcount * ccount * hcount;
