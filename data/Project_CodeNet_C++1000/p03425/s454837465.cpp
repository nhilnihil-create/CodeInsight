...
#define triple(a, b, c) (m[(a)] * m[(b)] * m[(c)])
    long long ans = triple('M', 'A', 'R') + triple('M', 'A', 'C') + triple('M', 'A', 'H') + triple('M', 'R', 'C') + triple('M', 'R', 'H') + triple('M', 'C', 'H') + triple('A', 'R', 'C') + triple('A', 'R', 'H') + triple('A', 'C', 'H') + triple('R', 'C', 'H');
