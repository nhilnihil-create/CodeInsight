...
signed main()
{
    ...
    for(auto x:mp){
        if(x.sc%4==0) a[4]++;
        else if(x.sc%2==0) a[2]++;
        else if(x.sc%2==1) a[1]++;
    }
    if(w%2==0&&h%2==0){
        if(a[2]==0&&a[1]==0) cout<<"Yes"<<endl;
        else cout<<"No"<<endl;
    }
    else if(w%2==0){
        if(a[1]==0&&a[2]<=w/2) cout<<"Yes"<<endl;
        else cout<<"No"<<endl;
    }
    else if(h%2==0){
        if(a[1]==0&&a[2]<=h/2) cout<<"Yes"<<endl;
        else cout<<"No"<<endl;
    }
    else{
        if(a[1]<=1&&a[2]<=(h/2)+(w/2)) cout<<"Yes"<<endl;
        else cout<<"No"<<endl;
    }
}