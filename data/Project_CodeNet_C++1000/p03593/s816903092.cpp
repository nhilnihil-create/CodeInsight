...
int main()
{
    ...
    loop(i, 'z' - 'a' + 1)
    {
        alphacount[(char)('a' + i)] = 0;
    }
    loop(i, h) loop(j, w) alphacount[s[i][j]]++;
    if (h % 2 == 0 && w % 2 == 0)
    {
        loop(i, h * w / 4)
        {
            loop(j, 'z' - 'a' + 1)
            {
                if (alphacount[(char)('a' + j)] >= 4){
                    alphacount[(char)('a' + j)] -= 4;
                break;
                }
            }
        }
    ...
    if (h % 2 == 1 && w % 2 == 0)
    {
        ...
        loop(i,w/2){
            loop(j, 'z' - 'a' + 1)
            {
                if (alphacount[(char)('a' + j)] >= 2){
                    alphacount[(char)('a' + j)] -= 2;
                break;
                }
            }
        }
        ...
        loop(j, 'z' - 'a' + 1)
        {
            if (alphacount[(char)('a' + j)] !=0)check=false;
        }
        if (check)
            putout("Yes");
        else
    ...
    if (h % 2 == 1 && w % 2 == 1)
    {
        ...
        loop(i,1){
            loop(j, 'z' - 'a' + 1)
            {
                if (alphacount[(char)('a' + j)] >= 1){
                    alphacount[(char)('a' + j)] -= 1;
                break;
                }
            }
        }
