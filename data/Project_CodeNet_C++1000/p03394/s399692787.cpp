...
int main(){
  ...
  if(n==19999){
    rep(i,15000)a[i]=(i+1)*2;
    rep(i,5000)b[i]=i*6+3;
    rep(i,15000)if(a[i]!=6)printf("%lld ",a[i]);
    rep(i,5000)printf("%lld ",b[i]);
    return 0;
  }
  if(n%2==0){
    rep(i,15000)a[i]=(i+1)*2;
    rep(i,5000)b[i]=i*6+3;
    x=15000;
    rep(i,min((n-1)/6*6,x))printf("%lld ",a[i]);
    rep(i,max(n-(n-1)/6*6,n-x))printf("%lld ",b[i]);
  }
  else{
    rep(i,15000)a[i]=(i+1)*2;
    rep(i,5000)b[i]=i*6+3;
    x=14997;
    rep(i,min(n/6*6-3,x))printf("%lld ",a[i]);
    rep(i,max(n-n/6*6+3,n-x))printf("%lld ",b[i]);
  }
}
