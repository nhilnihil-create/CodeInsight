...
int main() {
	...
	SINT64 N;	cin >> N;
		...
		SINT64 b = 15;	
	if (N == 3) {
		puts(2);	puts(5);	put(63);
	} else if (N == 4) {
		puts(2);	puts(5);	puts(20);	put(63);
	} else if (N == 5) {
		puts(2);	puts(4);	puts(6);	puts(3);	put(9);
	} else if (N == 6) {
		puts(2);puts(3);puts(5);put(10);puts(4);put(6);
	} else {

		puts(2);	puts(4);	puts(6);	puts(3);	puts(9);
		N -= 5;
		while(N != 0) {
			if (N==19994) {
				while(b <= 30000) {
