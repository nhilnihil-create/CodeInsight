...
###################ABOUT FIND FUNCTION IN DISJOINT SET -> work always is to return the parent of the set nothing itn has to do
...
// If logic is simple that don't try to need the length of the tree make it as a logn by checking
