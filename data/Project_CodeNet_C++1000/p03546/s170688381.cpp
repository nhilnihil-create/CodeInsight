...
int main()
{
    ...
    std::vector<std::vector<long long>> c(10, std::vector<long long>(10));
    for (int i = 0; i < 10; i++) {
        for (int j = 0; j < 10; j++) {
            std::cin >> c[i][j];
        }
    ...
    std::vector<std::vector<long long>> min_val(10, std::vector<long long>(10));

    for (int start = 0; start < 10; start++) {
        std::vector<long long> leng(10, mod), v(10, 0);
        leng[start] = 0;
