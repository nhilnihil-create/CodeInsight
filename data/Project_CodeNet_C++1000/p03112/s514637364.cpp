...
signed main(){
	...
	rep(0,i,q){
		...
		int a1=abs(t-sm)+min(abs(sm-tm),abs(sm-tu));
		int a2=abs(su-t)+min(abs(su-tm),abs(su-tu));
		int a3=abs(t-tm)+min(abs(tm-sm),abs(tm-su));
		int a4=abs(tu-t)+min(abs(tu-sm),abs(tu-su));
