...
int main(){
  ...
  //  cout<<ans<<endl;
    ...
    cin>>xx;
    x.push_back(xx);
    auto itr=upper_bound(s.begin(),s.end(),xx);
    ll sa=-1,sb=-1;
    ...
    //cout<<sa<<" "<<sb<<endl;
    itr=upper_bound(t.begin(),t.end(),xx);
    ll ta=-1,tb=-1;
    ...
    //cout<<ta<<" "<<tb<<endl;
    if(sa!=1&&ta!=1){
      ans=lmin(ans,llabs(xx-sa)+llabs(sa-ta));
      ans=lmin(ans,llabs(xx-ta)+llabs(ta-sa));
    }
  //  cout<<ans<<endl;
    if(sb!=-1&&ta!=-1){
      ans=lmin(ans,llabs(xx-sb)+llabs(sb-ta));
      ans=lmin(ans,llabs(xx-ta)+llabs(ta-sb));
    }
  //cout<<ans<<endl;
    if(sb!=-1&&tb!=-1){
      ans=lmin(ans,llabs(xx-sb)+llabs(sb-tb));
      ans=lmin(ans,llabs(xx-tb)+llabs(tb-sb));
    }
    //cout<<ans<<endl;
    if(sa!=-1&&tb!=-1){
      ans=lmin(ans,llabs(xx-sa)+llabs(sa-tb));
      ans=lmin(ans,llabs(xx-tb)+llabs(tb-sa));
    }
    cout<<ans<<endl;
  }
