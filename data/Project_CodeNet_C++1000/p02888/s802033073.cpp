...
int main() {
    ...
    sort(l.begin(),l.end());
    Int ans = 0;
    for (Int hidari = 0; hidari < n - 1;hidari++){
        for (Int naka = hidari+1; naka < n; naka++){
            auto migi = lower_bound(l.begin(),l.end(),l.at(hidari) + l.at(naka));
            //auto migi = lower_bound(l.begin(),l.end(),l.at(hidari) + l.at(naka) - 1);
            ans += -(distance(migi, l.end())) + n - 1 - naka;
            //naka - 1 + n 
            //hidari - 1
        }
    }
