// ref: https://img.atcoder.jp/abc096/editorial.pdf
...
vector<int> prime_list(int size){
...
int main(){
    ...
    int N; cin >> N;
    vector<int> vPrime = prime_list(55555);
    
    for(int i=0, cnt=0; i<(int)vPrime.size() && cnt<N; ++i){
        if(vPrime[i] % 5 == 1){
            ++cnt;
            cout << vPrime[i] << ' ';
        }
