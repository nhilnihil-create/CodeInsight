...
tree_order_statistics_node_update> ordered_set; // use less_equal for multi_set
// set_name.order_of_key (val) returns the no. of values less than val
// set_name.find_by_order (k) returns the iterator to k th largest element.(0-based)
// set_name.erase(itr) can't delete on basis of value but can delete iterator
// set_name.lower_bound(x) to find iterator of value x in ordered_set
// set_name.upper_bound(x) to find iterator of value x in ordered_multi_set
int v[N];
ll sum[N];
int main()
{
