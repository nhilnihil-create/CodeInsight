...
void solve() {
	...
	sortl(add)
	sortl(sub)
	o(max({add[n - 1] - add[0], sub[n - 1] - sub[0]}))
...
//Credits: https://stackoverflow.com/questions/8006697/finding-maximum-distance-between-x-y-coordinates
//Proof Credits: https://codeforces.com/blog/entry/82566?#comment-695694