...
int main(){
    ...
    for(int i = 0; i < h; i++){
        ...
        for(int j = 0; j < w; j++){
            ...
            if(a[i][j]%2==0){
                if(bring){
                    s.push_back(make_pair(make_pair(i,j-1),make_pair(i,j)));
                }
                else{
                    ;
                }
    ...
    for(int i = 0; i < h; i++){
        ...
        if(a[i][j]%2==0){
            if(bring){
                s.push_back(make_pair(make_pair(i-1,j),make_pair(i,j)));
            }
            else{
                ;
            }
    ...
    for(int i = 0; i < s.size(); i++){
        cout<<s[i].first.first+1<<" "<<s[i].first.second+1<<" "<<s[i].second.first+1<<" "<<s[i].second.second+1<<endl;
    }
    return 0;
}
