...
int main(){
  ...
  if(abs(n-m) > 1){
    ...
    if(n == m){
    cout << facctorialMethod(m)%1000000007 * facctorialMethod(n)%1000000007 * 2%1000000007 << endl;
	return 0;
    }
    else{
      cout << facctorialMethod(m)%1000000007 * facctorialMethod(n)%1000000007 << endl;
	return 0;
    }
  }
}