...
double J_sushi(int n, int x, int y, int z) {
	...
	return dp[x][y][z] = (n + x * J_sushi(n, x - 1, y, z) + y * J_sushi(n, x + 1, y - 1, z) + z * J_sushi(n, x, y + 1, z - 1)) / (x + y + z);
}
...
int32_t main() {
	...
	cout << J_sushi(n, one, two, three) << endl;
}