...
/*
    ...
    Title : DP_J_Modified.cpp
    Date : 29/08/2020   >> 17:22:14
*/
...
long double E(int n1, int n2, int n3, int n) {
    if (n1 == 0 && n2 == 0 && n3 == 0)  
        return 0.0;
    ...
    ans += n1 ? E(n1 - 1, n2, n3, n) * n1 : 0.0;
    ans += n2 ? E(n1 + 1, n2 - 1, n3, n) * n2: 0.0;
    ans += n3 ? E(n1, n2 + 1, n3 - 1, n) * n3: 0.0;
...
int32_t main(int argc,char** argv){
    ...
    int n; cin >> n;
    int n1 = 0, n2 = 0, n3 = 0;
    vi a(n); repa(i, n) cin >> a[i], n1 += (a[i] == 1), n2 += (a[i] == 2), n3 += (a[i] == 3);
    
    
    memset(dp, -1, sizeof(dp));
    cout << setprecision(12) << E(n1, n2, n3, n) << endl;
