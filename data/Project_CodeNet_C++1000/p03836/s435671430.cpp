...
int main(){
    ...
    llong inner_right = tx-sx;
    llong inner_up  = ty-sy;
    llong outer_right = inner_right+1;
    llong outer_up  = inner_up+1;

    for(int i=0; i<inner_right; i++){
        cout << "R";
    }
    for(int i=0; i<inner_up; i++){
        cout << "U";
    }
    for(int i=0; i<inner_right; i++){
        cout << "L";
    ...
    cout << "L";
    for(int i=0; i<outer_up; i++){
        cout << "U";
    }
    for(int i=0; i<outer_right; i++){
        cout << "R";
    }
    cout << "D";
    cout << "R";
