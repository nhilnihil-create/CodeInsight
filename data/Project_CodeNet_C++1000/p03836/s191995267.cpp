...
void solve(){
    ...
    string forth0 = ""; rep(i,dx) forth0 += "R"; rep(i,dy) forth0 += "U";
    string forth1 = "";
    string back0  = ""; rep(i,dx)  back0 += "L"; rep(i,dy)  back0 += "D";
    string back1  = "";
    
    forth1 += "D"; rep(i,dx+1) forth1 += "R"; rep(i,dy+1) forth1 += "U"; forth1 += "L";
    back1  += "U"; rep(i,dx+1) back1  += "L"; rep(i,dy+1) back1  += "D"; back1  += "R";
    
    cout << forth0 << back0 << forth1 << back1 << endl;
