...
void search(string &s, string &t, char a, char b, int p, int q, string &ans)
{
    int n = s.length();
    rep(i, n)
    {
...
int main()
{
    ...
    string s, t, ans = "YES";
    cin >> s >> t;
    search(s, t, 'D', 'U', sy, h, ans);
    search(s, t, 'U', 'D', h + 1 - sy, h, ans);
    search(s, t, 'R', 'L', sx, w, ans);
    search(s, t, 'L', 'R', w + 1 - sx, w, ans);
    cout << ans << rt;
    return 0;
}
