...
//better approach:- merge any number grater then both his neightbors (nbrlft+nbrrt-maxval) and then do the greedy approach
//ref:-https://www.youtube.com/watch?v=pOv4LRNt0jo
