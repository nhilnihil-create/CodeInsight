...
//    zerohanbetu = p.first;
  ...
  if(shurui == 1){
    ...
    if(s.at(0) == 0 && s.at(1) != 0 && t.at(0) == n/3 && t.at(1) ==2*n/3){
      flag = 1;
    }
//    cout << s.at(0) << endl;
//    cout << s.at(1) << endl;
...
//    cout << k.at(1) << endl;
//    cout << k.at(2) << endl;
    ll num = w.at(0) ^ w.at(1);
    num = num ^ w.at(2);
    if(k.at(0) == n/3 && k.at(1) == n/3 && k.at(2) == n/3 && num == 0){
      flag = 1;
    }
  }
...
/*
  ...
  if(n%3 != 0 || shurui >=4){
    ...
    for(auto p:mp){
   	 ...
   	 if(k.at(0)*3 == n && k.at(1)*3 == n && k.at(2)*3 == n){
    	  flag = 1;
    	}
	  }
    ...
    if(k.at(0) == 0 && s.at(0)*3 == n && k.at(1) != 0 && s.at(1)*3/2 == n){
      flag = 1;
    	}
	  }
  }
