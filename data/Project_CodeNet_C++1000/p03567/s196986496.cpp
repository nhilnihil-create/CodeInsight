...
int main(void){
    Cin(string, s);
    if(s.size() >= 5 && s[3] == 'A' && s[4] == 'C'){ Cout("Yes"); return 0; }
    if(s.size() >= 4 && s[2] == 'A' && s[3] == 'C'){ Cout("Yes"); return 0; }
    if(s.size() >= 3 && s[1] == 'A' && s[2] == 'C'){ Cout("Yes"); return 0; }
    if(s.size() >= 2 && s[0] == 'A' && s[1] == 'C'){ Cout("Yes"); return 0; }
    Cout("No");
}
