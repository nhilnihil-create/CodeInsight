...
void Dufaux()
{
    ...
    for(int i=0;i<n;i++){
        ...
        else if(number>=400 && number<=799){
            arr[1]++;
        }
        else if(number>=800 && number<=1199){
            arr[2]++;
        }
        else if(number>=1200 && number<=1599){
            arr[3]++;
        }
        else if(number>=1600 && number<=1999){
            arr[4]++;
        }
        else if(number>=2000 && number<=2399){
            arr[5]++;
        }
        else if(number>=2400 && number<=2799){
            arr[6]++;
        }
        else if(number>=2800 && number<=3199){
            arr[7]++;
        }
        else{
            cnt++;
