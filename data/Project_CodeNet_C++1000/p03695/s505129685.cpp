...
void vfun()
{
    ...
    fo(i,n)
    {
        ...
        if(v[i]>=0 && v[i]<=3)
            ...
            color[1]=1;
        else if(v[i]>=8 && v[i]<=11)
            color[2]=1;
        else if(v[i]>=12 && v[i]<=15)
            color[3]=1;
        else if(v[i]>=16 && v[i]<=19)
            color[4]=1;
        else if(v[i]>=20 && v[i]<=23)
            color[5]=1;
        else if(v[i]>=24 && v[i]<=27)
            color[6]=1;
        else if(v[i]>=28 && v[i]<=31)
            color[7]=1;
        else r++;
    }
    //showvector<bool>(color);
    ll m=0;
    fo(i,8)
    {
        if(color[i]==1)
