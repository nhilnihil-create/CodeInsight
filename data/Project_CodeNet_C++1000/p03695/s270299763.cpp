...
signed main() {
    ...
    rep(i, N) {
        cin >> A[i];
        if (A[i] < 400)B[0]=1;
        else if (A[i] < 800)B[1]=1;
        else if (A[i] < 1200)B[2]=1;
        else if (A[i] < 1600)B[3]=1;
        else if (A[i] < 2000)B[4]=1;
        else if (A[i] < 2400)B[5]=1;
        else if (A[i] < 2800)B[6]=1;
        else if (A[i] < 3200)B[7]=1;
        else B[8]++;
    }
    rep(i, 9) ans += B[i];
    cout << (ans-B[8]==0? 1:ans - B[8]) << " " << ans << endl;
}