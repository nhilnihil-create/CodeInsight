...
int main(){
    ...
    rep(i, n){
        ll a; cin >> a;
        if(a <= 399) v[0] = true;
        else if(a <= 799) v[1] = true;
        else if(a <= 1199) v[2] = true;
        else if(a <= 1599) v[3] = true;
        else if(a <= 1999) v[4] = true;
        else if(a <= 2399) v[5] = true;
        else if(a <= 2799) v[6] = true;
        else if(a <= 3199) v[7] = true;
        else cnt++;
    }
    rep(i, 8){
        if(v[i]) ans++;
    }
    cout << lmax(1, ans) << ' ' << ans + cnt << endl;
}
