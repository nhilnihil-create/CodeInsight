...
int main() {
  ...
  REP(i,n) {
    if(a[i]<400) m["gray"]++;
    if(400<=a[i]&&a[i]<800) m["brown"]++;
    if(800<=a[i]&&a[i]<1200) m["green"]++;
    if(1200<=a[i]&&a[i]<1600) m["lightblue"]++;
    if(1600<=a[i]&&a[i]<2000) m["blue"]++;
    if(2000<=a[i]&&a[i]<2400) m["yellow"]++;
    if(2400<=a[i]&&a[i]<2800) m["orange"]++;
    if(2800<=a[i]&&a[i]<3200) m["red"]++;
    if(3200<=a[i]) any++;
  }
  if(m.size()==0) {
    cout << "1 " << any << endl;
