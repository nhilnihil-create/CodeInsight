...
int main()
{
  ...
  ROF(i,4,16){
    ...
    s2=9*i;
    ROF(j,1000,10000){
      rep(k,keta(j*POW2(10,i-4)+POW2(10,i-4)-1,10)){
        t+=DEC(j*POW2(10,i-4)+POW2(10,i-4)-1,10,k);
      }
      if(s*t>=(j*POW2(10,i-4)+POW2(10,i-4)-1)*s2){
        p.push(j*POW2(10,i-4)+POW2(10,i-4)-1);
        s=j*POW2(10,i-4)+POW2(10,i-4)-1;
        s2=t;
      }
    t=0;
    }
