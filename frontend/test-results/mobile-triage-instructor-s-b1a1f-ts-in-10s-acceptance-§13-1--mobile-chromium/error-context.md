...
- Name: mobile-triage.spec.js >> instructor sees top-3 at-risk students in < 10s (acceptance §13.1)
- Location: tests/e2e/mobile-triage.spec.js:9:1
...
Locator: getByText('AT-RISK QUEUE')
Expected: visible
Timeout: 9000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 9000ms
  - waiting for getByText('AT-RISK QUEUE')
