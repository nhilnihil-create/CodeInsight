...
- Name: mobile-triage.spec.js >> admin overview surfaces the evaluation queue (acceptance §13.11)
- Location: tests/e2e/mobile-triage.spec.js:23:1
...
Locator: getByText(/Review pending evaluations/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Review pending evaluations/)
...
- paragraph: Sign in to continue to CodeInsight · Pampanga State University · CCS
- text: EMAIL
- textbox "EMAIL":
...
- textbox "PASSWORD":
  - /placeholder: ••••••••
- button "Sign In"
- text: "Demo accounts (password: password123) Instructor: instructor@psu.edu Student: maria@student.psu.edu"
