...
- Name: codeinsight-e2e.spec.js >> CodeInsight E2E Multi-Context CDS Verification >> Context B: Maria submits code with tab-switch and reaches HIGH CDS
- Location: tests/codeinsight-e2e.spec.js:133:7
...
Call log:
  - navigating to "http://localhost:5173/student/exercises", waiting until "load"
